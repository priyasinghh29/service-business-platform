<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="email_id" name="email_id" type="email" class="mt-1 block w-full" :value="old('email_id', $user->email_id)" required autocomplete="username" />
            <x-input-error class="mt-2" :messages="$errors->get('email_id')" />
